...
public class Sm_manage_medicine extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_sm_manage_medicine);
		...
		e1.setOnKeyListener(new OnKeyListener() {
			...
			public boolean onKey(View arg0, int arg1, KeyEvent arg2) {
				...
				ListAdapter adapter = new SimpleAdapter(
						Sm_manage_medicine.this, tmp, R.layout.list_item,
	...
	class GetMedicine extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(Sm_manage_medicine.this);
		...
		protected void onPostExecute(String file_url) {
			...
			runOnUiThread(new Runnable() {
				public void run() {
					pDialog.dismiss();
					ListAdapter adapter = new SimpleAdapter(
							Sm_manage_medicine.this, medicineList,
							R.layout.list_item,
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.sm_manage_medicine, menu);
		return true;
	}
