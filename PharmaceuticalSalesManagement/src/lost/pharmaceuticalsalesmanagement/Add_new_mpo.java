...
public class Add_new_mpo extends Activity {
	private ProgressDialog pDialog;
	JSONparser jParser = new JSONparser();
	JSONArray Area = null;
	String url = StaticData.s + "pharSalesMng/addMpo.php";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_add_new_mpo);
	...
	class AddMpo extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(Add_new_mpo.this);
			pDialog.setMessage("Add new mpo. Please wait...");
	...
	public void onBackPressed() {
		// TODO Auto-generated method stub
		Intent in = new Intent(getApplicationContext(), Admin_manage_mpo.class)
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.add_new_mpo, menu);
		return true;
	}
