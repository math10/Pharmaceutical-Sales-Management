...
public class Update_sm_info extends Activity {
	...
	TextView msg;
	Button up;
	String url = StaticData.s + "pharSalesMng/update_sm.php";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_update_sm_info);
		Intent i = getIntent();
	...
	class UpdateMpo extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(Update_sm_info.this);
			pDialog.setMessage("Updateing Sales Manager info. Please wait...");
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.update_sm_info, menu);
		return true;
	}
