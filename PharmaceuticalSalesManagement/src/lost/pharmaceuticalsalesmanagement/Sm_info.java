...
public class Sm_info extends Activity {
	...
	TextView t1, t2;
	Button up, del;
	String url1 = StaticData.s + "pharSalesMng/singleSm.php",
			url2 = StaticData.s + "pharSalesMng/deleteSm.php";
	...
	class GetSm extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(Sm_info.this);
	...
	class DeleteSm extends AsyncTask<String, String, String> {
		boolean flag;
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.sm_info, menu);
		return true;
	}
